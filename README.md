...
Current AVs have many sensors and give control to the driver for improving safety. Incidents such as Uber's accident and Tesla's accidents (2018, 2019) show that AVs (and drivers) can fail to detect cyclists.
